...
function Home() {
  ...
  return (
    <div className=" home w-full h-full flex flex-col justify-center items-center overflow-hidden">
      ...
      <div
        id="about"
        className=" about relative w-[60vw] md:w-[50vw] h-screen flex flex-col justify-center items-center"
      >
        <iframe
          className=" blob absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-[4] md:scale-[3.5] lg:scale-[6]"
        ...
        <p className=" aboutPara text-[5vw] md:text-[2vw] lg:text-[1.5vw] text-center font-medium text-slate-600">
          ...
          &nbsp; website load time improvement and &nbsp;
          <span className=" text-slate-700 font-bold lg:text-[2vw]">
            $3200+
          </span>
          &nbsp; monthly labor cost savings by optimizing HR workflows,
          overhauling the platform, and developing CSS frameworks. Explore my
